...
.submitbutton:hover {
  ...
  <?php 
    ...
    $images=mysqli_real_escape_string($conn,$_GET['images']);
  ?>
...
<div id="content">
   <form method="POST" action="tagspost.php" enctype="multipart/form-data">
   
   <div class="mb-3">
    <label class="form-label"> Book Name</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="Book_name" required>
   </div>
      
   <div class="mb-3">
    <label class="form-label"> Author Name</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="Authors" required>
   </div>

      <textarea id="editor"  name="Book_about" required> About the Book </textarea> <br>

      <div class="mb-3">
    <label class="form-label"> Book Cover</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $images ?>" name="images" readonly>
   </div>
    ...
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="Language" required>
   </div>

   
    <input type="hidden" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $id ?>" name="Book_Id" required>
   

   <div class="mb-3">
    <label class="form-label"> Book Tags</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="Tags" required>
   </div>
